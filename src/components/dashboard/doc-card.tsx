...
export function DocCard({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-md p-3.5 cursor-pointer hover:border-gray-300 dark:hover:border-gray-700 hover:shadow-md hover:shadow-black/5 transition-all"
    >
