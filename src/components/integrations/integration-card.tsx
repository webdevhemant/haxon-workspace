        ...
        <div className="flex items-start gap-3 mb-2.5">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {integration.popular && (
                <span className="text-[9.5px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-orange-100 dark:bg-orange-950/40 text-orange-600 dark:text-orange-300">
                  Popular
                </span>
              )}
              {integration.recommended && (
                <span className="text-[9.5px] font-semibold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-sky-100 dark:bg-sky-950/40 text-sky-600 dark:text-sky-300">
                  Recommended
                </span>
              )}
            </div>
...
export function handleToggle(integration: Integration): boolean {
  toast(integration.connected ? `${integration.name} disconnected` : `${integration.name} connected`);
