      ...
      <SettingSection title="Personal info" desc="This is how others will see you on Haxon.">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <button className="mt-1 px-3 py-1.5 border border-gray-200 dark:border-gray-700 rounded-lg text-xs font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors self-start">Change avatar</button>
            <div className="text-xs text-gray-400">JPG, PNG up to 1MB</div>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div>
            <label className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-1.5 block">Name</label>
        ...
        {[
          ...
          <div key={item.label}>
            ...
            <div className="flex justify-between items-center py-1">
              ...
              <button className="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm shadow-orange-500/20">
                {i === 0 ? "Change" : "Enable"}
              </button>
            </div>
          </div>
