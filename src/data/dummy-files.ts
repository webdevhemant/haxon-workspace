...
export const FILES: FileAsset[] = [
  ...
  {
    id: "f3",
    name: "sync-engine-architecture.png",
    kind: "image",
    size: "2.1 MB",
    source: "Haxon",
    uploadedById: "u3",
  ...
  {
    id: "f4",
    name: "partial-response-demo.mp4",
    kind: "video",
    size: "18 MB",
    source: "Loom",
    uploadedById: "u1",
