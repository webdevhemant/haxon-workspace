...
export const AUTOMATIONS: Automation[] = [
  ...
  },
  {
    ...
    description: "Every weekday at 09:00 PT, post yesterday's shipped cards and today's plan to #standup.",
    enabled: false,
...
export const AUTOMATION_TEMPLATES: AutomationTemplate[] = [
  { id: "t1", emoji: "🎯", name: "Auto-assign by label", desc: "When a card gets a #design label, assign it to the design lead.", trigger: "Label added to card", action: "Assign to Sana Khoury", category: "Boards" },
  { id: "t2", emoji: "🧹", name: "Archive stale cards", desc: "Move cards inactive for 30 days to Archived.", trigger: "Card untouched for 30d", action: "Move to Archived", category: "Boards" },
  { id: "t3", emoji: "✨", name: "AI standup digest", desc: "Daily AI summary of who shipped what.", trigger: "Daily at 09:00", action: "Post to #standup", category: "Chat" },
  { id: "t4", emoji: "📝", name: "Doc → task", desc: "When a doc adds an action item, create a card.", trigger: 'Doc adds "[ ] …"', action: "Create card in Inbox", category: "Docs" },
  { id: "t5", emoji: "📆", name: "Event prep doc", desc: "30 min before a meeting, create a prep doc.", trigger: "30m before event", action: "Create doc from template", category: "Calendar" },
  { id: "t6", emoji: "🚨", name: "Critical incident page", desc: "When a card with #incident is created, page on-call.", trigger: "Card tagged #incident", action: "DM + email on-call", category: "Boards" },
];
