...
export const GOALS: Goal[] = [
  {
    ...
    keyResults: [
      {
        id: "kr1",
        title: "Land 10 enterprise design partners",
        progress: 70,
        target: "10",
        current: "7",
        ownerId: "u2",
      ...
      {
        id: "kr2",
        title: "Self-serve activation rate ≥ 38%",
        progress: 55,
        target: "38%",
        current: "21%",
        ownerId: "u1",
      ...
      {
        id: "kr3",
        title: "AI features adopted by 60% of teams",
        progress: 40,
        target: "60%",
        current: "24%",
        ownerId: "u3",
  ...
  },
  {
    ...
    keyResults: [
      ...
      {
        id: "kr5",
        title: "Reconnect time < 2s in p99",
        progress: 60,
        target: "<2s",
        current: "2.6s",
        ownerId: "u6",
      ...
      {
        id: "kr6",
        title: "Migration plan for existing workspaces",
        progress: 25,
        target: "100%",
        current: "25%",
        ownerId: "u4",
  ...
  },
  {
    ...
    description:
      "Move from 'AI workspace' to 'permissions-first AI workspace'. Refresh site, docs, and pricing.",
    period: "Q3 2026",
    status: "on-track",
    ownerId: "u2",
    ...
    keyResults: [
      {
        id: "kr7",
        title: "New positioning doc shipped",
        progress: 100,
        target: "1",
        current: "1",
        ownerId: "u2",
